...
This app is a solo project that I'm making right after learning React Native. For now it's only for Windows, but I'm planning to also make Android and iOS versions.
...
* As shown in the [React Native for Windows Guide](https://microsoft.github.io/react-native-windows/docs/getting-started#running-a-react-native-windows-app)
